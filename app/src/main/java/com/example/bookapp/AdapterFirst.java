...
public class AdapterFirst extends RecyclerView.Adapter<Viewholder> {
    ...
    public AdapterFirst(Context context){
    ...
    public void onBindViewHolder( Viewholder holder, int position) {
        holder.title.setText(MainActivity.first.get(position).getTitle());
        String imageaddress=MainActivity.first.get(position).getImg1();
    ...
    public int getItemCount() {
        return MainActivity.first.size();
    }
}
